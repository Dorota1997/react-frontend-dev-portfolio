			...
			<ul>
				<li>
					<a
						...
						class="hover:opacity-75 transition-opacity"><Icon icon="bi:linkedin" width="50px" /></a
					>
				</li>
				<li>
					<a href="https://github.com/seanred360" class="hover:opacity-75 transition-opacity"
						><Icon icon="mdi:github" width="50px" /></a
					>
				</li>
			</ul>
		</div>
		<div class="border-2 border-black rounded-xl overflow-hidden dark:bg-[#272727]">
			<WindowBar hasCloseButton={false} />
			<p class="px-[16px] py-[32px]" use:concurrent={{ interval: 15 }}>{bioText}</p>
		</div>
	</div>
</section>
